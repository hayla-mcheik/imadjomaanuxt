        ...
        <table class="min-w-full divide-y divide-gray-200">
          <thead class="bg-gray-50">
            <tr>
              ...
              <th scope="col" class="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Location</th>
...
/>
                  ...
                  <div class="ml-4">
                    ...
                    <div class="text-sm text-gray-500 line-clamp-2 mt-1">{{ event.description }}</div>
                  </div>
                </div>
              </td>
              <td class="px-6 py-5">
                <div class="flex items-center">
                  ...
                  <span class="text-sm text-gray-700">{{ event.locations || 'Not specified' }}</span>
                </div>
              </td>
          ...
          <div class="bg-white px-6 py-8 sm:p-8">
            <div class="sm:flex sm:items-start">
              ...
              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div class="mt-4">
                  <p class="text-gray-600">Are you sure you want to delete "<span class="font-medium">{{ events.find(e => e.id === eventToDelete)?.title || 'this event' }}</span>"? This action cannot be undone.</p>
                </div>
              </div>
            </div>
          </div>
...
const saveEvent = async () => {
  ...
  try {
    ...
    formData.append('locations', modalForm.value.locations);
    ...
    let url = isEditing.value 
      ? `${apiBaseUrl}/events/${modalForm.value.id}`
      : `${apiBaseUrl}/events`;
    ...
    const savedEvent = response.data.events || response.data;
...
const deleteEvent = async () => {
  ...
  try {
    await axios.delete(`${apiBaseUrl}/events/${eventToDelete.value}`, {
      headers: {
        Authorization: `Bearer ${authStore.token}`
      }
    });
